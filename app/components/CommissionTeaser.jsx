...
export default function CommissionTeaser() {
  return (
    <section className="bg-[#043852] py-8">
      <div className="mx-auto flex max-w-5xl flex-col items-center gap-4 px-6 text-center">
        <span className="eyebrow text-white">Custom Commissions</span>
        ...
        <Link
          href="/commission"
          className="mt-2 inline-flex items-center gap-3 border border-white px-8 py-4 text-sm font-semibold uppercase tracking-[0.15em] text-white transition hover:border-[#a9822e] hover:text-[#a9822e]"
        >
